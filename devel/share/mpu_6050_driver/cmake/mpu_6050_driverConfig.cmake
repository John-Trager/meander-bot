...
if("TRUE" STREQUAL "TRUE")
  set(mpu_6050_driver_SOURCE_PREFIX /home/john/meander-bot/src/mpu_6050_driver)
  set(mpu_6050_driver_DEVEL_PREFIX /home/john/meander-bot/devel)
  ...
  set(mpu_6050_driver_INSTALL_PREFIX /home/john/meander-bot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mpu_6050_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/john/meander-bot/src/mpu_6050_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/john/meander-bot/devel/lib;/home/john/meander-bot/devel/lib;/opt/ros/melodic/lib)
