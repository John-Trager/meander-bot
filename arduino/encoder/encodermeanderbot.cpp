...
meanderbot::Encoder::Encoder(ros::NodeHandle& nh, uint8_t pin1, uint8_t pin2, int encoder_resolution)
  : nh_(nh)
  , encoder(pin1, pin2)
...
meanderbot::JointState meanderbot::Encoder::jointState()
{
...
double meanderbot::Encoder::angularPosition()
{
    return joint_state_.angular_position_;
}


double meanderbot::Encoder::angularVelocity()
{
    return joint_state_.angular_velocity_;
}

double meanderbot::Encoder::ticksToAngle(const int &ticks) const
{
