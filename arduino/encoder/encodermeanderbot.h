/*
 * Original Author: Franz Pucher
 * Adapted by John Trager
 */

#ifndef ENCODERMEANDERBOT_H
#define ENCODERMEANDERBOT_H
...
namespace meanderbot
{
    struct JointState
    {
        ...
        {
            return (angular_position_ != other.angular_position_) ||
                (angular_velocity_ != other.angular_velocity_);
        }
    };


    /** \brief Decorates the Teensy/Arduino Encoder Library to read the angular wheel velocity
    ...
    {
    public:
        // Teensy/Arduino Encoder class that is capable of reading rising and falling edges of two Hall effect signals.
        ::Encoder encoder;
        ...
        /** \brief Get the measure the angular joint position
         *
         * Calculates the angular position of the wheel joint using the encoder ticks.
         * 
         * \returns angular wheel joint position (rad(s))
         */
